...
namespace GuessNumber.Classes
{
    class OptionTwoCheng : IOption
    {
        ...
        // generated random number, from 1 to 20
         ...
         * @parameters: nil
         * @return: [int] 0 means qual, 1 means random number greater than input number, -1 mean random nubmer less than input number, 2 means input is not in the range
        ...
        public int CompareNumber()
        {
            if (inputNumber <= 20)
            {
                ...
                {
                    Console.WriteLine("Your input is more than the random number!");
                    return -1;
                }
                else
                {
